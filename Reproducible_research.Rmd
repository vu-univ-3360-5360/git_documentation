...
This document is adapted from an introduction to reproducible research that
I wrote for the laboratory section of my Global Climate Change class, and 
thus it has a lot of emphasis on climate science.
...
We won't get into it in this course, but there is a powerful tool 
called RMarkdown, which
allows you to combine the text of your documents with scripts that perform 
data analysis and generate the figures and tables.
Thus, any time you change a number in your data or change a line of code in your
analysis script, the computer can automatically regenerate your document to 
update all of the numbers and figures accordingly.
This approach is widely used both in scientific research and in business,
where it can easily automate the generation of monthly or quarterly reports
from data.
...
In this document, I will focus on _computational reproducibility_.
I will not address all the details of computational reproducibility, 
but I  will focus on three important aspects:
...
* **Revision Control:**
  ...
  Another important use of revision control is not relevant to this course,
...
I use these methods extensively in my own research.
